...
void init_triton_passes_ttgpuir(py::module &&m) {
  ...
  ADD_PASS_WRAPPER_0("add_arithmetic_transformation", createTraitonGPUArithmeticTransformation);
  ADD_PASS_WRAPPER_0("add_remove_reduce", createTritonGPURemoveReduce);
